...
<article class="page-container">
    <form class="form form-horizontal" id="form_permission_update">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-4">上级权限：</label>
            <div class="formControls col-xs-4 col-sm-6">
                <input type="hidden" id="id" name="id"/>
                <input type="hidden" id="pid" name="pid"/>
                <input type="text" class="input-text" value="" placeholder="上级权限名称(点击后进行选择)" readonly="readonly"
...
<script type="text/javascript"
        src="<c:url value="/js/system/permission/permission_update.js" /> "></script>

<script type="text/javascript">
    var id = '${id}';
    PermissionUpdate.init();
</script>
</body>
</html>