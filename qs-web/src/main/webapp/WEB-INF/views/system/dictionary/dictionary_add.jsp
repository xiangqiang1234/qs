...
<article class="page-container">
    <form class="form form-horizontal" id="form_dictionary_add">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-4">上级字典：</label>
            <div class="formControls col-xs-4 col-sm-5">
                <input type="hidden" id="pid" name="pid"/>
                <input type="text" class="input-text" value="" onclick="DictionaryAdd.addFormShowPerTreeUi();"
                       placeholder="上级字典名称(点击后进行选择)" readonly="readonly" id="pidname" name="pidname">
            </div>
        </div>
        <div class="row cl">
...
<script type="text/javascript"
        src="<c:url value="/js/system/dictionary/dictionary_add.js" /> "></script>
<script type="text/javascript">
    DictionaryAdd.init();
</script>
</body>
